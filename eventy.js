function pobierzZdarzenia(gracz) {
    ...
    let dostepneEventy = [
        ...
        {
            tekst: "Udzielasz wywiadu dla Łączy nas Dart. Redaktor prowadzący wywiad pyta cię, jakie masz rady dla początkujących darterów.",
            opcje: [
                { tekst: "Odpowiadam redaktorowi.", akcja: "wywiad_lnd" }
            ]
        },
        {
            tekst: "Młody fan prosi o zdjęcie.",
            opcje: [
                { tekst: "Zgadzam się.", akcja: "fota_tak" },
                { tekst: "Nie zgadzam się.", akcja: "fota_nie" }
            ]
        },
        {
            tekst: "Kibice buczą gdy wychodze na scene.",
            opcje: [
                { tekst: "Robię miny na scenie i ich podburzam.", akcja: "kibice_miny" },
                { tekst: "Zmieniam walk on na losowy.", akcja: "kibice_muzyka" }
            ]
        }
    ];

    if (!gracz.dozywotniKontrakt) {
        dostepneEventy.push({
